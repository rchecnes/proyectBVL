  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav">
      <?php if($_SESSION['nom_role']=='ROLE_ADMIN'):?>
        ...
        <li class="<?=($url=='/Controller/DepositoEmpresaC.php?accion=index')?'active':''?>"><a href="../Controller/DepositoEmpresaC.php?accion=index">Depositos - Empresa</a></li>
        <li class="<?=($url=='/Controller/DepositoCostoC.php?accion=index')?'active':''?>"><a href="../Controller/DepositoCostoC.php?accion=index">Depositos - Tasas y Costos</a></li>
